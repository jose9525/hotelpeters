    ...
    collapse: function(){
      $collapseSidebarEl.on('click', function(e) {
        if ($app.hasClass('sidebar-sm')) {
          ...
          $('.offcanvas-toggle').addClass('visible-xs-inline');
          $('.offcanvas-toggle').removeClass('visible-sm-inline');
        }
    ...
    offcanvas: function() {
      $offcanvasToggleEl.on('click', function(e) {
        if ($app.hasClass('offcanvas-opened')) {
          ...
          $('.offcanvas-toggle').addClass('visible-sm-inline');
          $('.offcanvas-toggle').removeClass('visible-xs-inline');
          $app.removeClass('sidebar-xs');
          $app.addClass('sidebar-sm');
